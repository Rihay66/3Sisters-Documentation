...
This class is an abstract class meaning YOU HAVE TO inherit this class which means creating a class that inherits from Window. For example App class inherits from Window:
```cpp
// app.hpp
